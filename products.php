      ...
      <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
              ...
              <!-- End of Topbar -->
                ...
                <div class="container">
                  <h2>Add Products <i class="fas fa-plus-circle"></i></h2>
                </div>
                <form method="post" action="products.php" class="user">
                  <?php include('errors.php'); ?>
                  <div class="container">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputName" placeholder="Product Name" name="name">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Price" name="price">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" placeholder="Category" name="cat">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" placeholder="Details" name="details">
                    </div>
                    <button type="submit" name="add_prod" class="btn btn-primary btn-user btn-block">
                      <i class="fas fa-plus-circle"></i>
                      Add Product
                    </button>
                    <hr>
