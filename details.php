          ...
          <div id="content">
              ...
              <div class="container">
                  <div class="card shadow mb-4">
                      ...
                      <div class="card-body">
                          <p>A
                            <span style="font-weight:bold">CEO</span> dashboard lets your
                            <span style="font-weight:bold">CEO</span> or
                            <span style="font-weight:bold">Manger</span>
                            track business performance and easily
                            see only the high-level digital marketing and sales data they need.
                            It makes it simple for your CEO to stay on top of everything from gross sales to
                            revenue growth to ad spend and everything in between.</p>
                      </div>
                  </div>
                  ...
                  <div class="card shadow mb-4">
                      <div class="card-header py-3">
                          <h6 class="m-0 font-weight-bold text-primary">Used Tools</h6>
                      </div>
                      <div class="card-body">
                          <div>
